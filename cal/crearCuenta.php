...
<body>
	...
	<div style="float: left">
		<div style="margin-top: 25px;margin-left: 100px; float: left; width: 30vw"> 
			...
			<img id="carga" src="img/carga.gif" style="height: 35px; margin-bottom: -12px; position: relative;left: 7px; display: none;"/>
			<img id="checkOk" src="img/ok.png" style="height: 35px; margin-bottom: -12px; position: relative;left: 7px;display: none;"/>
			<img id="checkError" src="img/error.png" style="height: 35px; margin-bottom: -12px; position: relative;left: 7px;display: none;"/><br/>
